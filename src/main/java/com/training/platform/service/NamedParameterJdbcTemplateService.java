...
import com.training.platform.repository.NamedParameterJdbcTemplateRepository;
...
public class NamedParameterJdbcTemplateService {
    @Autowired
    private NamedParameterJdbcTemplateRepository jdbcTemplateRepository;
    ...
    public void updateUser(String id, UserBean user)  {
        try {
            int result = jdbcTemplateRepository.updateUser(id, user);
    ...
    public void deleteUser(String id)  {
        try {
            int result = jdbcTemplateRepository.deleteUser(id);
